...
export default function ThoughtVault({ notes, setNotes, tasks = [], prompts = [], onNewNote }) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 glass-panel p-5 rounded-2xl">
        ...
        <div className="flex items-center space-x-3 self-start md:self-auto">
          {/* View Mode Toggle: Grid vs Graph */}
          ...
          <button
            ...
            className="btn-neon-cyan flex items-center justify-center space-x-2 px-4 py-2 rounded-xl font-medium text-xs"
          >
      ...
      {/* Main Content: Neural Graph vs Card Grid */}
      {viewMode === 'graph' ? (
        <KnowledgeGraph
          notes={filteredNotes}
          tasks={tasks}
          prompts={prompts}
          onSelectNode={(node) => {
            if (node.type === 'note') openEditModal(node.raw);
          }}
        />
